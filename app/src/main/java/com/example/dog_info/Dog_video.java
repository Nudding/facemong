...
public class Dog_video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textview = (TextView) findViewById(R.id.tv_receivename3);
        ...
        Button button1 = (Button) findViewById(R.id.cancle_button);
        ...
        mDatabase.child("users").child("1").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.getValue(User.class) != null){
                    ...
                    Toast.makeText(Dog_video.this, "데이터 없음...", Toast.LENGTH_SHORT).show();
                }
            }
